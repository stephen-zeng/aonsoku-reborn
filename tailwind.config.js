...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      screens: {
        "mid-player": { raw: "(min-height: 161px) and (max-height: 228px)" },
        "mini-player": { raw: "(max-height: 160px)" },
      },
    },
  },
  plugins: [
