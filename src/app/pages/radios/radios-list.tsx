...
import { RadiosListFallback } from "@/app/components/fallbacks/song-fallbacks";
...
export default function Radios() {
  ...
  if (isLoading) return <RadiosListFallback />;

  const showTable = radios && radios.length > 0;

  return (
    <div className={clsx("w-full", showTable ? "min-h-content" : "min-h-content")}>
      <ShadowHeader
